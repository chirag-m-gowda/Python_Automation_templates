...
# Download and install all the below mentioned packages before implementing this project. 
...
engine.setProperty('voice', voices[1].id) # change voice of assistant to female/male
